...
func TestReElection(t *testing.T) {
	...
	log.Printf("Test: election after network failure ...\n")
	...
	for i := 0; i < servers-1; i++ {
		...
		log.Printf("Test: Disconnect %d node ...\n", (leader2+i)%servers)
	}
	...
	for i := 1; i < servers-1; i++ {
		...
		log.Printf("Test: Connected %d node ...\n", (leader2+i)%servers)
	}
